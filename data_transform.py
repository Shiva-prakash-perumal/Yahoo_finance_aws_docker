...
if __name__ == "__main__":
    ...
    raw_bucket = os.getenv("RAW_BUCKET", "yahoo-finance-stock")  # Raw data S3 bucket
    transformed_bucket = os.getenv("TRANSFORMED_BUCKET", "yahoo-finance-stock")  # Transformed data S3 bucket
